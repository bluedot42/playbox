...
# size = {1000: ['KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'],
...
#         filesize /= multiple
#         if filesize < multiple:
#             return '{0:.1f}{1}'.format(filesize, suffix)

#     raise ValueError('FileSize too big...')


# if __name__ == '__main__':
#     print(determine_size(1000000000, True))
...
class ToRomanBadInput(unittest.TestCase):
    ...
    def test_no_integer(self):
        ...
        self.assertRaises(roman1.NotIntegerError, roman1.to_roman, 1.5)
...
class RoundtripCheck(unittest.TestCase):
    ...
    def test_roundtrip(self):
        ...
        for integer in range(1, 4000):
            ...
            result = roman1.from_roman(numeral)
            # print('{0}\t{1}'.format(integer, result))
